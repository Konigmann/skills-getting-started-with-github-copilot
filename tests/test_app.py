...
def test_signup_for_missing_activity_returns_404(client):
    # Act
    response = client.post("/activities/Nonexistent%20Club/signup", params={"email": "student@mergington.edu"})
...
def test_unregister_missing_activity_returns_404(client):
    # Act
    response = client.delete("/activities/Nonexistent%20Club/participants", params={"email": "student@mergington.edu"})
